...
jQuery(document).ready(function($) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success && response.data.url) {
                    ...
                    alert(response.data.message || '<?php _e('Erreur lors de la création du lien', 'vina-stripe-connect'); ?>');
    ...
    // Refresh button
    $('.stripe-connect-refresh-btn').on('click', function(e) {
        e.preventDefault();
        $('.stripe-connect-btn').trigger('click');
    });

    // Dashboard button
    $('.stripe-connect-dashboard-btn').on('click', function(e) {
        e.preventDefault();
